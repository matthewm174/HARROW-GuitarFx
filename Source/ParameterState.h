	...
	public:
		...
		static juce::AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
		{
			return juce::AudioProcessorValueTreeState::ParameterLayout{
				...
				std::make_unique<juce::AudioParameterFloat>("tubeMix", "Tube Mix",                  juce::NormalisableRange<float>{0.f, 1.0f, 0.01f},		0.f),		
				std::make_unique<juce::AudioParameterFloat>("tubeBias", "Tube Bias",                juce::NormalisableRange<float>{0.f, 2.0f, 0.1f},		0.f),		
				std::make_unique<juce::AudioParameterFloat>("tubeIn", "Tube Input",                 juce::NormalisableRange<float>{0.f, 5.0f, 0.1f},		0.f),		
				std::make_unique<juce::AudioParameterFloat>("tubeOut", "Tube Output",               juce::NormalisableRange<float>{0.f, 5.0f, 0.1f},		0.f),		
				std::make_unique<juce::AudioParameterFloat>("tubeDrive", "Tube Drive",              juce::NormalisableRange<float>{0.f, 5.0f, 0.1f},		0.f),		
				std::make_unique<juce::AudioParameterFloat>("midEqFreq", "Low-Mid Freq",            juce::NormalisableRange<float>{500.f, 3000.0f, 0.1f},	500.0f),	
				...
				std::make_unique<juce::AudioParameterFloat>("hiEqFreq", "Hi-Mid Freq",              juce::NormalisableRange<float>{3000.f, 5000.f, 0.1f},	3000.f),	
				std::make_unique<juce::AudioParameterFloat>("hiEqQ", "Hi-Mid Q",                    juce::NormalisableRange<float>{0.1f, 1.0f, 0.1f},		1.0f),	
				std::make_unique<juce::AudioParameterFloat>("hiEqGain", "Hi-Mid Gain",              juce::NormalisableRange<float>{-12.f, 12.f, 0.1f},		0.0f),			
				std::make_unique<juce::AudioParameterFloat>("drive", "Distortion Level",            juce::NormalisableRange<float>{0.f, 10.0f, 0.1f},		1.0f),	
				std::make_unique<juce::AudioParameterFloat>("driveThresh", "Distortion Press UP",   juce::NormalisableRange<float>{1.f, 2.0f, 0.1f},		1.0f),		
