	...
	public:
		...
		static juce::AudioProcessorValueTreeState::ParameterLayout createParameterLayout()
		{
			return juce::AudioProcessorValueTreeState::ParameterLayout{
				std::make_unique<juce::AudioParameterFloat>("gain", "Gain",                         juce::NormalisableRange<float>{0.f, 80.0f, 0.1f}, 1.f),//    ngPreRatioSlider.setRange(1.0f, 10.0f, 1.0f);
				...
				std::make_unique<juce::AudioParameterFloat>("tubeDrive", "Tube Drive",              juce::NormalisableRange<float>{0.f, 1.0f, 0.1f}, 1.f),//    ngPostRatioSlider.setRange(0.0f, 10.0f, 1.0f);
				...
				std::make_unique<juce::AudioParameterFloat>("drive", "Distortion Level",            juce::NormalisableRange<float>{0.f, 1.0f, 0.1f}, 1.0f),//    tubeOG.setRange(0.0f, 5.0f);
				...
				std::make_unique<juce::AudioParameterFloat>("ngPreRatio", "NG1 Ratio",              juce::NormalisableRange<float>{1.1f, 10.0f, 0.1f}, 2.0f),//    delayFeedback.setRange(0.0f, 100.0f);
				std::make_unique<juce::AudioParameterFloat>("ngPreAtk", "NG1 Attack",               juce::NormalisableRange<float>{0.5f, 10.0f, 0.1f}, 2.0f),//    hiEqFreqKnob.setRange(3000.0f, 5000.0f, 10.0f);
				...
				std::make_unique<juce::AudioParameterFloat>("ngPostRatio", "NG2 Ratio",             juce::NormalisableRange<float>{1.1f, 10.0f, 0.1f}, 2.0f),//    hiEqGainKnob.setRange(-12.0f, 12.0f, 1.0f);
